...
/**
 * SDL_close - cleans memory, quits SDL and closes windows
 * @renderer: The renderer
 * @window: The window
 * @cosine: The cosine lookup table
 * @sine: The sine lookup table
 * @tangent: The tangent lookup table
 * @aTan: The arc tangent lookup table
 */
